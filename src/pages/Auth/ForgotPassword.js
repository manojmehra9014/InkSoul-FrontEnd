      ...
      <div className="max-w-md w-full space-y-8">
          ...
          {status === 'success' ? (
            <div className="text-center py-6">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                Please check your inbox for the password reset link. The link will expire in 1 hour.
              </p>
              <Link
                to="/login"
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link to="/login" className="font-medium text-ink-600 dark:text-ink-400 hover:text-ink-700 dark:hover:text-ink-300">
              Sign in
            </Link>
          </p>
        </div>
