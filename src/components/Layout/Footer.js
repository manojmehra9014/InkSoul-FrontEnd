      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-10 h-10 bg-gradient-to-r from-ink-600 to-soul-600 rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-xl">I</span>
              </div>
              <span className="text-2xl font-bold bg-gradient-to-r from-ink-400 to-soul-400 bg-clip-text text-transparent">
                InkSoul
              </span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              Premium printed apparel and accessories. Express your unique style with our carefully curated collection of t-shirts, handkerchiefs, socks, gloves, and more.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="https://pinterest.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-200">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex w-full md:w-auto">
              <input
                ...
                className="flex-1 md:w-64 px-4 py-2 bg-gray-800 border border-gray-700 rounded-l-lg focus:outline-none focus:border-ink-500 text-white"
              />
              <button className="px-6 py-2 bg-gradient-to-r from-ink-600 to-soul-600 text-white rounded-r-lg hover:shadow-lg transition-all duration-200">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 InkSoul. All rights reserved.
          </p>
